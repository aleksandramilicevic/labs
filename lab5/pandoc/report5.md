...
![ тест Ферма](images/fermat_test.jpg){ width=70% }
...
![ модуло алгоритм](images/modular_exponentiation.jpg){ width=70% }
...
![ Якоби алгоритм](images/jacobi_symboljpg.jpg){ width=70% }
...
![ соловей штрассен алгоритм](images/solovay_strassen_test.jpg){ width=70%}
...
![ миллера рабина алгоритм](images/miller_rabin_test.jpg){ width=70%}
